...
const (
	...
	OutputHtmlRanking_IndexFilename  = "index.html"
	OutputHtmlRanking_ByIdFolder     = "by_id"
	OutputHtmlRanking_ByMeritFolder  = "by_merit"
	OutputHtmlRanking_ByCourseFolder = "by_course"
